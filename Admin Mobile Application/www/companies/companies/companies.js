(function () {
    ...
    CompaniesController.$inject = ['dataservice', '$scope', '$ionicModal', 'popup'];
    function CompaniesController(dataservice, $scope, $ionicModal, popup) {
        var vm = this;
        ...
        function removeCompany(companyId) {
            var confirmResponse = popup.confirmPopup('Delete Company', 'Are you sure you want to delete this?');
